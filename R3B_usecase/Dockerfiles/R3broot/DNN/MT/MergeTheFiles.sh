...
then
    ...
    then
        ...
        root -b -l -q "MergeFiles.cpp($1,0)"
        root -b -l -q "MergeFiles.cpp($1,1)"
        root -b -l -q "MergeFiles.cpp($1,2)"
        root -b -l -q "MergeFiles.cpp($1,3)"
    elif [ $1 -eq '2' ]
    then
...
root -b -l -q "MergeHists.cpp($1,0)"
root -b -l -q "MergeHists.cpp($1,1)"
root -b -l -q "MergeHists.cpp($1,2)"
root -b -l -q "MergeHists.cpp($1,3)"
