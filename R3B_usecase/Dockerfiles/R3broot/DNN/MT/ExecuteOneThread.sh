...
then
    ...
    then
        ...
        cd ../Macros/
        root -b -l -q "MCtransport.cpp($1,$2)"
        root -b -l -q "NeuLAND_Digitizer.cpp($1,$2)"
        root -b -l -q "NeuLAND_JanClusters.cpp($1,$2)"
        root -b -l -q "NeuLAND_Translation.cpp($1,$2)"
        root -b -l -q "ClusterSignals.cpp($1,$2)"
        cd ../MT/
    else
